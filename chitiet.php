...
$id = $_GET['id'];
$id_plus=$id+1;
$data = $connect->query("select * from tintuc where tintuc_id = '$id'");
$data_plus = $connect->query("select * from tintuc where tintuc_id = '$id_plus'");
$result = $data->fetchAll(); 
$result_plus = $data_plus->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
...
<!---------------------------------------------------------------------------------------------------------------------------------->
                    ...
                    ?>
                        <h2 class="mb-3"><?php echo $v['tieude'] ?></h2>

                        <p><?php echo $v['ngaythang'] ?></p>
                        <img src="images/<?php echo $v['hinhanh'] ?>" alt="" class="img-fluid">
                        </p>
                    ...
                    <div class="tag-widget post-tag-container mb-5 mt-5">
                        <div class="tagcloud">
                            <p>Tin liên quan nổi bật khác</p>
                        </div>
                    </div>

                    <div class="about-author d-flex p-4 bg-light">
                    <?php
                    foreach ($result_plus as $k => $v) {
                    ?>
                        <div class="bio mr-5">
